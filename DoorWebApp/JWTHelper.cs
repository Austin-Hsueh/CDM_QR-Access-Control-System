...
namespace JWT
{
    /// <summary>
    /// 參考網址:
    /// htDoor://blog.miniasp.com/post/2019/12/16/How-to-use-JWT-token-based-auth-in-aspnet-core-31
    /// </summary>
    public class JWTHelper
    {
        ...
        public string GenerateToken(TblUser user, bool IsNeverExpire)
        {
            var issuer = Configuration.GetValue<string>("JwtSettings:Issuer");
            var signKey = Configuration.GetValue<string>("JwtSettings:SignKey");
            var expireMinutes = Configuration.GetValue<int>("JwtSettings:ExpireMinutes");
            if (IsNeverExpire) expireMinutes = 999999; //about 19 years
            ...
            // htDoor://stackoverflow.com/questions/47279947/idx10603-the-algorithm-hs256-requires-the-securitykey-keysize-to-be-greater
