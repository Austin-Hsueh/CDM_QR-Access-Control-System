...
namespace DoorWebDB.Migrations
{
    ...
    [Migration("20240831154231_addPermissionIdsToQrcode")]
    partial class addPermissionIdsToQrcode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoorDB.TblRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CanDelete = false,
                            CreatedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(454),
                            CreatorUserId = 1,
                            Description = "管理者",
                            IsDelete = false,
                            IsEnable = true,
                            ModifiedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(454),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CanDelete = false,
                            CreatedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(456),
                            CreatorUserId = 1,
                            Description = "老師",
                            IsDelete = false,
                            IsEnable = true,
                            ModifiedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(456),
                            Name = "User"
                        },
                        new
                        {
                            Id = 3,
                            CanDelete = false,
                            CreatedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(457),
                            CreatorUserId = 1,
                            Description = "學生",
                            IsDelete = false,
                            IsEnable = true,
                            ModifiedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(458),
                            Name = "User"
                        },
                        new
                        {
                            Id = 4,
                            CanDelete = false,
                            CreatedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(459),
                            CreatorUserId = 1,
                            Description = "值班人員",
                            IsDelete = false,
                            IsEnable = true,
                            ModifiedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(459),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("DoorDB.TblUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 51,
                            AccountType = "LOCAL",
                            CreateTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(439),
                            DisplayName = "Administrator",
                            Email = "",
                            IsDelete = false,
                            IsEnable = true,
                            LastLoginIP = "",
                            ModifiedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(448),
                            Phone = "0",
                            Secret = "1qaz2wsx",
                            Username = "admin",
                            locale = 1
                        ...
                        new
                        {
                            Id = 52,
                            AccountType = "LOCAL",
                            CreateTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(452),
                            DisplayName = "臨時大門",
                            Email = "",
                            IsDelete = false,
                            IsEnable = true,
                            LastLoginIP = "",
                            ModifiedTime = new DateTime(2024, 8, 31, 23, 42, 30, 811, DateTimeKind.Local).AddTicks(452),
                            Phone = "0",
                            Secret = "1qaz2wsx",
                            Username = "TemDoor",
                            locale = 1
            ...
            modelBuilder.Entity("TblPermissionTblQRCodeStorage", b =>
                {
                    b.Property<int>("PermissionsId")
                        .HasColumnType("int");

                    b.Property<int>("QRCodeStoragesId")
                        .HasColumnType("int");

                    b.HasKey("PermissionsId", "QRCodeStoragesId");

                    b.HasIndex("QRCodeStoragesId");

                    b.ToTable("TblPermissionTblQRCodeStorage");
                });

            modelBuilder.Entity("TblQRCodeStorageTblStudentPermission", b =>
                {
                    b.Property<int>("StudentPermissionsId")
                        .HasColumnType("int");

                    b.Property<int>("StudentQRCodeStoragesId")
                        .HasColumnType("int");

                    b.HasKey("StudentPermissionsId", "StudentQRCodeStoragesId");

                    b.HasIndex("StudentQRCodeStoragesId");

                    b.ToTable("TblQRCodeStorageTblStudentPermission");
                });
            ...
            modelBuilder.Entity("TblPermissionTblQRCodeStorage", b =>
                {
                    ...
                    b.HasOne("DoorDB.TblQRCodeStorage", null)
                        .WithMany()
                        .HasForeignKey("QRCodeStoragesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TblQRCodeStorageTblStudentPermission", b =>
                {
                    ...
                    b.HasOne("DoorDB.TblQRCodeStorage", null)
                        .WithMany()
                        .HasForeignKey("StudentQRCodeStoragesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
