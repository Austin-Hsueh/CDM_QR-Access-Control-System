...
namespace DoorWebDB.Migrations
{
    ...
    [Migration("20240725145029_modifyQrcode")]
            ...
            modelBuilder.Entity("DoorDB.TblRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CanDelete = false,
                            CreatedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5248),
                            CreatorUserId = 1,
                            Description = "管理者",
                            IsDelete = false,
                            IsEnable = true,
                            ModifiedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5249),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CanDelete = false,
                            CreatedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5257),
                            CreatorUserId = 1,
                            Description = "老師",
                            IsDelete = false,
                            IsEnable = true,
                            ModifiedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5259),
                            Name = "User"
                        },
                        new
                        {
                            Id = 3,
                            CanDelete = false,
                            CreatedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5262),
                            CreatorUserId = 1,
                            Description = "學生",
                            IsDelete = false,
                            IsEnable = true,
                            ModifiedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5263),
                            Name = "User"
                        },
                        new
                        {
                            Id = 4,
                            CanDelete = false,
                            CreatedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5266),
                            CreatorUserId = 1,
                            Description = "值班人員",
                            IsDelete = false,
                            IsEnable = true,
                            ModifiedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5267),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("DoorDB.TblUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 51,
                            AccountType = "LOCAL",
                            CreateTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5219),
                            DisplayName = "Administrator",
                            Email = "",
                            IsDelete = false,
                            IsEnable = true,
                            LastLoginIP = "",
                            ModifiedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5231),
                            Phone = "0",
                            Secret = "1qaz2wsx",
                            Username = "admin",
                            locale = 1
                        ...
                        new
                        {
                            Id = 52,
                            AccountType = "LOCAL",
                            CreateTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5239),
                            DisplayName = "臨時大門",
                            Email = "",
                            IsDelete = false,
                            IsEnable = true,
                            LastLoginIP = "",
                            ModifiedTime = new DateTime(2024, 7, 25, 22, 50, 27, 581, DateTimeKind.Local).AddTicks(5240),
                            Phone = "0",
                            Secret = "1qaz2wsx",
                            Username = "TemDoor",
                            locale = 1
