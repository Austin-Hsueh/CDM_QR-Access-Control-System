...
namespace DoorDB
{
    public class DoorDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new TblPermissionGroup(){Id = 1, Name = "大門", NameI18n= "" },
                new TblPermissionGroup(){Id = 2, Name = "儲藏室", NameI18n= "" },
                new TblPermissionGroup(){Id = 3, Name = "門3", NameI18n= "" },
                new TblPermissionGroup(){Id = 4, Name = "門4", NameI18n= "" },
            };
            ...
            modelBuilder.Entity<TblUser>()
                ...
                .UsingEntity(j => j.HasData(
                    new { UsersId = 1, QRCodesId = 1 },
                    new { UsersId = 1, QRCodesId = 2 }
                 ));
